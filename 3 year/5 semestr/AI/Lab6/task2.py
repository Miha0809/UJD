...
class washing_machine:
    ...
    rule10 = ctrl.Rule(degree_dirt['High'] & wash_time['very_short'], wash_time['VeryLong'])
    rule11 = ctrl.Rule(degree_dirt['High'] & wash_time['medium'], wash_time['VeryLong'])
    rule12 = ctrl.Rule(degree_dirt['Medium'] & wash_time['long'], wash_time['long'])
